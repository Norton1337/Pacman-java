...
public class PinkGhost extends Creature{
	...
	//Animation
		...
		private int pinkDotsCounter = 0;
		private int dotsLimit=0;
		
	

	public PinkGhost(Handler handler, float x, float y, int width, int height) {
		...
		this.setInCage(true);
		//Animations
		animRight = new Animation(100,Assets.pinkGhostR);
		animLeft = new Animation(100,Assets.pinkGhostL);
		animUp = new Animation(100,Assets.pinkGhostU);
		animDown = new Animation(100,Assets.pinkGhostD);
	...
	*/
	...
	public int getPinkDotsCounter() {
		return pinkDotsCounter;
	}

	public void setPinkDotsCounter(int pinkDotsCounter) {
		this.pinkDotsCounter = pinkDotsCounter;
	}
